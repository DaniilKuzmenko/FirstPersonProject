...
public class InventoryManager : MonoBehaviour
{
    ...
    {
        ItemData item = new ItemData(this.items[itemId].name, this.items[itemId].description, this.items[itemId].id, this.items[itemId].count, this.items[itemId].isUniq);
    ...
    public void InstantiateItem(ItemData item, Transform parent, List<GameObject> items)
    {
        ...
        currentItem.transform.Find("ItemCount").GetComponent<Text>().color = item.isUniq ? Color.clear : new Color(1, 0.6627451f, 0, 1);
